    ...
    switch(v1->type) {
      case ZVARIANT_INT:
        switch(v2->type) {
          ...
          case ZVARIANT_LONG:
            return (v1->value.i == v2->value.l);
          case ZVARIANT_BOOL:
            return (v1->value.i == v2->value.b);
          case ZVARIANT_DOUBLE:
            return (v1->value.i == v2->value.d);
          case ZVARIANT_FLOAT:
            return (v1->value.i == v2->value.f);
          default:
            return false;
        };
        break;
      case ZVARIANT_LONG:
        switch(v2->type) {
          case ZVARIANT_INT:
            return (v1->value.l == v2->value.i);
          case ZVARIANT_LONG:
            return (v1->value.l == v2->value.l);
          case ZVARIANT_BOOL:
            return (v1->value.l == v2->value.b);
          case ZVARIANT_DOUBLE:
            return (v1->value.l == v2->value.d);
          case ZVARIANT_FLOAT:
            return (v1->value.l == v2->value.f);
          default:
            return false;
        };
        break;
      case ZVARIANT_FLOAT:
        switch(v2->type) {
          case ZVARIANT_INT:
            return (v1->value.f == v2->value.i);
          case ZVARIANT_LONG:
            return (v1->value.f == v2->value.l);
          case ZVARIANT_BOOL:
            return (v1->value.f == v2->value.b);
          case ZVARIANT_DOUBLE:
            return (v1->value.f == (float)v2->value.d);
          case ZVARIANT_FLOAT:
      ...
      case ZVARIANT_DOUBLE:
        switch(v2->type) {
          case ZVARIANT_INT:
            return (v1->value.d == v2->value.i);
          case ZVARIANT_LONG:
            return (v1->value.d == v2->value.l);
          case ZVARIANT_BOOL:
            return (v1->value.d == v2->value.b);
          case ZVARIANT_DOUBLE:
            return (v1->value.d == v2->value.d);
          case ZVARIANT_FLOAT:
            return ((float)v1->value.d == v2->value.f);
          default:
            return false;
        };
        break;
      case ZVARIANT_BOOL:
        switch(v2->type) {
          case ZVARIANT_INT:
            return (v1->value.b == v2->value.i);
          case ZVARIANT_LONG:
            return (v1->value.b == v2->value.l);
          case ZVARIANT_BOOL:
            return (v1->value.b == v2->value.b);
          case ZVARIANT_DOUBLE:
            return (v1->value.b == v2->value.d);
          case ZVARIANT_FLOAT:
            return (v1->value.b == v2->value.f);
          default:
            return false;
        };
        break;
